# 202603142052 — OpenAkita Agent 实例全景分析
...
```
文件: src/openakita/agents/profile.py
```
...
```
文件: src/openakita/agents/presets.py
```
...
```
文件: src/openakita/config.py (line 342)
```
...
```
文件: src/openakita/main.py (line 898)
```
...
```
文件: src/openakita/tools/definitions/agent.py
...
```
文件: src/openakita/core/ralph.py
```
...
```
文件: src/openakita/core/supervisor.py
```
...
> 分析基于 OpenAkita v1.26.2 源码，深度阅读了 agents/, core/, tools/ 下的 20+ 核心文件。
