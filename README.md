...
<p align="center">
  ...
  <img src="https://img.shields.io/github/v/release/did-tech/opencrab?style=flat-square" alt="Release" height="20" />
  <img src="https://img.shields.io/pypi/v/seeagent?color=green&style=flat-square" alt="PyPI" height="20" />
  <img src="https://img.shields.io/github/actions/workflow/status/did-tech/opencrab/ci.yml?branch=main&style=flat-square" alt="Build Status" height="20" />
</p>
...
**别人的 AI 只能聊天，SeeAgent 帮你做事。**

SeeAgent 是一款开源全能 AI 助手——多个 AI Agent 协作分工、自动上网搜索、操作你的电脑、管理文件、定时执行任务，还能接入飞书/钉钉/企微/Telegram/QQ 随时响应。它会记住你的偏好，会自己学新技能，遇到问题永不放弃。

**全图形化配置，5 分钟上手，全程不用敲一行命令。**

> **下载**：[GitHub Releases](http://gitlab.zhidaoauto.com/did-tech/opencrab/releases) — Windows / macOS / Linux
...
**全图形化，不用敲命令行**——这是 SeeAgent 和同类开源产品最大的区别：

<p align="center">
  <img src="docs/assets/desktop_quick_config.gif" alt="SeeAgent 快速配置" width="800" />
</p>
...
> **下载**：[GitHub Releases](http://gitlab.zhidaoauto.com/did-tech/opencrab/releases) — Windows (.exe) / macOS (.dmg) / Linux (.deb)

### 方式二：pip 安装

```bash
pip install seeagent[all]    # 安装全部可选功能（IM 通道 + 桌面自动化）
...
```bash
git clone http://gitlab.zhidaoauto.com/did-tech/opencrab.git
cd opencrab
...
```bash
seeagent                          # 交互式聊天
seeagent run "帮我写个计算器"       # 执行单个任务
seeagent serve                    # 服务模式（接入 IM）
seeagent serve --dev              # 开发模式，热加载
seeagent daemon start             # 后台守护进程
seeagent status                   # 查看运行状态
```
...
SeeAgent 支持**桌面端、Web 端、移动端**——随时随地，多端协同：
...
<p align="center">
  <img src="docs/assets/desktop_terminal.png" alt="SeeAgent 桌面应用" width="800" />
</p>
...
SeeAgent 内置完整的多 Agent 协作系统——不是只有一个 AI，而是一个 **AI 团队**：
...
[Issues](http://gitlab.zhidaoauto.com/did-tech/opencrab/issues) · [Discussions](http://gitlab.zhidaoauto.com/did-tech/opencrab/discussions) · [Star](http://gitlab.zhidaoauto.com/did-tech/opencrab)
...
<a href="https://star-history.com/#did-tech/opencrab&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=did-tech/opencrab&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=did-tech/opencrab&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=did-tech/opencrab&type=Date" />
 </picture>
</a>
...
<p align="center">
  <strong>SeeAgent — 开源多 Agent AI 助手，不只是聊天，是帮你做事的 AI 团队</strong>
</p>
