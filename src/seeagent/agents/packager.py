...
class AgentInstaller:
    ...
    def _write_origin(self, skill_dir: Path, *, source: str, version: str | None,
        ...
        """Write .seeagent-origin.json sidecar to track provenance."""
        data = {
            "source": source,
            "version": version or "",
            "type": origin_type,
