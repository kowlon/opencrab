...
async def health(request: Request):
    ...
    from seeagent import __git_hash__, get_version_string
    from seeagent import __version__ as backend_version
...
async def diagnostics():
    ...
    try:
        from seeagent.setup_center import bridge  # noqa: F401
        checks.append({
            "id": "C3_CORE",
            "title": "核心引擎",
            "status": "pass",
            "code": "CORE_OK",
            "evidence": [f"seeagent {backend_version}"],
            "autoFix": False,
            "fixHint": None,
        })
    ...
    return {
        ...
        "environment": {
            ...
            "seeagentVersion": backend_version,
            "pid": os.getpid(),
        },
    }
...
async def health_loop(request: Request):
    ...
    from seeagent.core.engine_bridge import is_dual_loop
