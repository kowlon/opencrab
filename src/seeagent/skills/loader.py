...
DEFAULT_DISABLED_SKILLS: frozenset[str] = frozenset({
    "seeagent/skills@algorithmic-art",
    ...
    "seeagent/skills@theme-factory",
    "seeagent/skills@todoist-task",
    "seeagent/skills@translate-pdf",
    "seeagent/skills@video-downloader",
    "seeagent/skills@webapp-testing",
...
class SkillLoader:
    ...
    def load_from_directory(self, directory: Path) -> int:
        ...
        for item in directory.iterdir():
            ...
            elif item.name in ("system", "external", "custom", "community", "builtin", "0seetime"):
    ...
    def _load_i18n(self, skill_dir: Path, metadata: SkillMetadata) -> None:
        ...
        优先 agents/openai.yaml 的 i18n 字段，回退 .seeagent-i18n.json。
        """
    ...
    def run_script(
        ...
        if script_path.suffix == ".py":
            ...
            from seeagent.runtime_env import get_python_executable
