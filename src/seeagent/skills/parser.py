...
class SkillMetadata:
    ...
    # metadata.seeagent structured fields
    ...
    # 国际化（由 agents/openai.yaml i18n 字段注入，兼容旧的 .seeagent-i18n.json）
...
class SkillParser:
    ...
    def _build_metadata(self, data: dict, path: Path) -> SkillMetadata:
        ...
        # Extract metadata.seeagent structured fields
        raw_metadata = data.get("metadata", {})
        akita_meta = raw_metadata.get("seeagent", {}) if isinstance(raw_metadata, dict) else {}
