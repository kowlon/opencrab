...
| 变更类型 | 接口 / 事件 | 说明 |
|---------|------------|------|
| **增强** | `GET /api/bp/instances` | 新增 `instance_title` 字段（实例级标题，区别于模板级 `bp_name`） |
| **增强** | `GET /api/bp/instances/{id}` | 新增 `instance_title` 字段 |
| **增强** | SSE `bp_instance_created` | 新增 `instance_title` 字段 |
| **增强** | SSE `bp_progress` | 新增 `instance_title` 字段 |
| **增强** | SSE `bp_complete` | 新增 `instance_title` 字段 |

> **`instance_title` 说明**: 每个 BP 实例在创建时生成的唯一标题，格式为 `"{语义} · {M/D HH:MM}"`。语义部分优先用 LLM 从用户意图生成，回退到用户原始 query 截断，最终兜底到 `config.name`。用于前端列表中区分同一模板的多个实例。旧实例（无该字段）回退显示 `bp_name`。
    ...
    },
    {
      ...
      "reply_state": {
        ...
        "bp_progress": {
          ...
          "bp_name": "市场分析",
          "instance_title": "市场趋势分析报告 · 4/16 14:32",
...
```
data: {"type": "bp_instance_created", "instance_id": "bp_inst_001", "bp_id": "market_analysis", "bp_name": "市场分析", "instance_title": "市场趋势分析报告 · 4/16 14:32", "run_mode": "manual", "subtasks": [{"id": "data_collection", "name": "数据收集"}, {"id": "trend_analysis", "name": "趋势分析"}, {"id": "report_gen", "name": "报告生成"}]}
...
data: {"type": "bp_progress", "instance_id": "bp_inst_001", "bp_name": "市场分析", "instance_title": "市场趋势分析报告 · 4/16 14:32", "statuses": {"data_collection": "done", "trend_analysis": "pending", "report_gen": "pending"}, "subtasks": [{"id": "data_collection", "name": "数据收集"}, {"id": "trend_analysis", "name": "趋势分析"}, {"id": "report_gen", "name": "报告生成"}], "current_subtask_index": 1, "run_mode": "manual", "status": "active"}
...
```
data: {"type": "bp_instance_created", "instance_id": "bp_inst_002", "bp_id": "competitor_analysis", "bp_name": "竞品分析", "instance_title": "竞品分析 · 4/16 15:10", "run_mode": "manual", "subtasks": [{"id": "target_select", "name": "目标选择"}, {"id": "comparison", "name": "对比分析"}]}
...
data: {"type": "bp_progress", "instance_id": "bp_inst_001", "bp_name": "市场分析", "instance_title": "市场趋势分析报告 · 4/16 14:32", "statuses": {"data_collection": "done", "trend_analysis": "done", "report_gen": "pending"}, "subtasks": [{"id": "data_collection", "name": "数据收集"}, {"id": "trend_analysis", "name": "趋势分析"}, {"id": "report_gen", "name": "报告生成"}], "current_subtask_index": 2, "run_mode": "manual", "status": "active"}
...
data: {"type": "bp_progress", "instance_id": "bp_inst_001", "bp_name": "市场分析", "instance_title": "市场趋势分析报告 · 4/16 14:32", "statuses": {"data_collection": "done", "trend_analysis": "done", "report_gen": "done"}, "subtasks": [{"id": "data_collection", "name": "数据收集"}, {"id": "trend_analysis", "name": "趋势分析"}, {"id": "report_gen", "name": "报告生成"}], "current_subtask_index": 3, "run_mode": "manual", "status": "completed"}

data: {"type": "bp_complete", "instance_id": "bp_inst_001", "instance_title": "市场趋势分析报告 · 4/16 14:32"}
...
data: {"type": "bp_progress", "instance_id": "bp_inst_002", "bp_name": "竞品分析", "instance_title": "竞品分析 · 4/16 15:10", "statuses": {"target_select": "done", "comparison": "pending"}, "subtasks": [{"id": "target_select", "name": "目标选择"}, {"id": "comparison", "name": "对比分析"}], "current_subtask_index": 1, "run_mode": "manual", "status": "active"}
  ...
  "instances": [
    {
      ...
      "bp_name": "相机特征检索出图",
      "instance_title": "查找园区东门相机 · 3/30 14:00",
    ...
    },
    {
      ...
      "bp_name": "市场调研报告",
      "instance_title": "Q1销售数据调研 · 3/29 09:15",
      "session_id": "seecrab_ff9f0f08ccec",
      "session_title": "帮我查园区东门的相机",
      "status": "completed",
      "run_mode": "auto",
...
| `instances[].instance_title` | string | 实例级标题（格式 `"{语义} · {M/D HH:MM}"`），用于区分同模板多实例。旧实例回退为 `bp_name` [v1.2 新增] |
...
| `bp_instance_created` | BP 实例创建 | `instance_id`, `bp_id`, `bp_name`, `instance_title` [v1.2], `run_mode`, `subtasks: [{id, name}]` |
| `bp_progress` | BP 进度更新 | `instance_id`, `bp_name`, `instance_title` [v1.2], `statuses`, `subtasks`, `current_subtask_index`, `run_mode`, `status` |
...
| `bp_complete` | BP 全部完成 | `instance_id`, `instance_title` [v1.2], `bp_id`, `bp_name`, `outputs` |
...
//   instance_id, bp_name, instance_title, progress, session_title,
