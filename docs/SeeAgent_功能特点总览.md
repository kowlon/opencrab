...
SeeAgent 是一款**全能自进化 AI 助手**，集成桌面应用、IM 通道、CLI 三端交互，支持多 Agent 协作、计划模式、记忆系统、技能市场、桌面/浏览器自动化，以及运行时监督与自我进化能力。定位为**真正解决问题**的 AI 助手，而非简单对话工具。
